		...
		<br>	
            <div class="row">
				...
				<div class="col-md-4 about-left">
					<a href="#"><img class="img-responsive" src="{{$product->image}}" alt=" "></a>
				</div>
				<div class="col-md-8 about-left">
					<h3 style="font-weight: bold;">{{$product->name}}</h3>				
						<ul class="blog-ic">
							<li><a href="#"><span> <i  class="glyphicon glyphicon-user"> </i>Super user</span> </a> </li>
							<li><span><i class="glyphicon glyphicon-time"> </i>June 15, 2013</span></li>		  						 	
							<li><span><i class="glyphicon glyphicon-eye-open"> </i>Hits:145</span></li>
						</ul>
					@if($product->getPrice())
					<h2 style="font-weight: bold;color: brown;">{{$product->price}}</h2>
					@else
					<h2 style="font-weight: bold;color: brown;">Liên hệ</h2>
					@endif
					<div style="background-color: #e0e0e0;height: 1px;width: 100%; margin: 1.67vw auto;"></div>
					<h4 style="font-weight:bold">Chi tiết sản phẩm</h4>		  						
					<p>{{$product->desc}}</p>
					<div style="background-color: #e0e0e0;height: 1px;width: 100%; margin: 1.67vw auto;"></div>
					<div class="about-btn" style="text-align: right;">
						<a href="">Đặt hàng</a>
					</div>
				</div>
				@else
				<div class="col-md-4 about-left">
					<a href="#"><img class="img-responsive" src="https://hidden.artisanfinefood.com//uploads/images/so-7-3430.jpg" alt=" "></a>
				</div>
				<div class="col-md-8 about-left">
